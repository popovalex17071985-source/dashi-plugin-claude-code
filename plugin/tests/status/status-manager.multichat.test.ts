...
// Multichat status suite: group routing on, so dm_only is off and the
// allowlist includes a supergroup chat id alongside the warchief DM.
function makeConfig(): AppConfig {
  return makeSharedConfig({
    dm_only: false,
