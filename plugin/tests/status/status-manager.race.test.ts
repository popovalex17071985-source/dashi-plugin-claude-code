...
// `overrides` patch the nested `status` block (concurrency tests flip
// suppress_typing_bubble). Default leaves the eager bubble on so the
// initial send is observable.
