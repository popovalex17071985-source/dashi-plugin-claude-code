...
// Status bubble OFF and permission relay DISABLED for this voice/multichat
// suite — local defaults over the shared fixture. BOT_ID / WARCHIEF_USER_ID
// match the canonical bot id and allowlist.
