...
C=install-e2e-$$
# Контейнер сносим ВСЕГДА, а не только в счастливом конце: при fail скрипт
# выходил раньше уборки, и упавший прогон оставлял systemd-контейнер висеть
# (05.09.2026 нашёлся такой, трёхдневный).
