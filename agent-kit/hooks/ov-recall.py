...
# Only this agent's own scope: «default» is the shared bucket every agent
# used to land in, and reading it handed one agent another's memory.
SCOPES = ("viking://user/__AGENT__/memories",)
