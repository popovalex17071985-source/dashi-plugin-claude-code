...
patterns=(
  ...
  # Дом раньше был прибит к одному пользователю (/home/edgelab): у агента на
  # чужом сервере снос собственной папки проходил мимо сторожа (19.09.2026).
  ...
  '(^|[;&|]|&&|[[:space:]]do)[[:space:]]*rm[[:space:]]+(-[a-zA-Z]*[rR][a-zA-Z]*[[:space:]]+)+[^[:space:]]*(__WORKSPACE__|/home/[a-zA-Z0-9_.-]+|~|\$HOME|\.claude|\.secrets|/data|/logs|/state|/hooks|/bin)([[:space:]/]|$)'
